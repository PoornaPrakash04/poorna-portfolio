...
const Experience = () => {
  ...
  return <section id="experience" className="py-20 bg-gray-900/30 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <div key={index} className="group bg-gray-900/50 p-8 rounded-2xl border border-gray-700/50 backdrop-blur-sm hover:border-yellow-500/30 transition-all duration-500 transform hover:scale-105 hover:rotate-1" style={{
            animationDelay: `${index * 100}ms`
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className={`text-xs font-medium px-2 py-1 rounded-full ${exp.status === 'Active' ? 'text-green-400 bg-green-400/10 border border-green-400/20' : 'text-gray-400 bg-gray-400/10 border border-gray-400/20'}`}>
                    {exp.status}
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {exp.highlights.map((highlight, idx) => <div key={idx} className="flex items-center group/highlight">
