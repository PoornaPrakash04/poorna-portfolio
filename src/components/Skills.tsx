  ...
  return <section id="skills" className="py-20 bg-gray-900/30 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          return <div key={categoryIndex} className="group bg-gray-900/50 p-8 rounded-2xl border border-gray-700/50 backdrop-blur-sm hover:border-blue-500/30 transition-all duration-500 transform hover:scale-105" style={{
            animationDelay: `${categoryIndex * 100}ms`
                ...
                <div className="space-y-6">
                  {category.skills.map((skill, skillIndex) => <div key={skillIndex} className="space-y-3 group/skill">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          return <div key={index} className="group bg-gray-900/50 p-6 rounded-xl border border-gray-700/50 backdrop-blur-sm hover:border-purple-500/30 transition-all duration-500 transform hover:scale-105 hover:-rotate-2 text-center" style={{
